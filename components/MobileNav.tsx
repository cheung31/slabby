...
const MobileNav = ({ pathname = '', className = '' }: MobileNavProps) => {
    return (
        ...
        >
            <BlurOverlay
                className={`flex-1 p-3 pt-2 bg-opacity-50 dark:bg-opacity-50 hover:bg-opacity-40 dark:hover:bg-opacity-70 ${
                    pathname === 'photo' ? styles.active : styles.tab
                }`}
            >
            ...
            <BlurOverlay
                className={`flex-1 p-3 pt-2 bg-opacity-50 dark:bg-opacity-50 hover:bg-opacity-40 dark:hover:bg-opacity-70 ${
                    pathname === 'tune' ? styles.active : styles.tab
                }`}
            >
                <Link href="/tune" passHref>
